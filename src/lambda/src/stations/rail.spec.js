...
describe('rail.js', () => {
  ...
  describe('#_processRailStationsBody', () => {
    ...
    it('should work as expected', () => {
      const spyFilterRailProperties = jest.spyOn(Rail, '_filterRailProperties').mockReturnValue(
        [
          { stationCode: 'CRGHW',
            stationFullName: 'Craughwell'
          },
      ...
      expect(spyFilterRailProperties).toHaveBeenCalledWith(mockStationsList, settings.railStationProperties, settings.railStationKeysMap);

      const mockFilteredStationsList = spyFilterRailProperties(mockStationsList, settings.railStationProperties, settings.railStationKeysMap);
